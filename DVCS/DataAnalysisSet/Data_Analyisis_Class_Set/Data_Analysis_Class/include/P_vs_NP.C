...
void BDT::P_vs_NP(TString Data, int NumEv)//, TCut cut, TString DVCS, TString Pi0, vector<TString> vars)
{
	  ...
	  for(int n=0;n<min(NBINS_x,NBINS - m*NBINS_Q);n++)
	    {
	      ...
	      Single_BSA_3("../Data_NP_Theta_g_5.root","Data_NP_Theta_g_5.root", boundaries, 12);
